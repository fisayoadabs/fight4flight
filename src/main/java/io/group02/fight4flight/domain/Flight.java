...
//     private Map<Seat, Customer> Seats;
//     private int FlightID;
    


//     public Flight(Location Destination, Location Origin, Date DepartureTime, Date ArrivalTime, Aircraft Aircraft, int FlightNumber, Map<Seat, Customer> Seats){
