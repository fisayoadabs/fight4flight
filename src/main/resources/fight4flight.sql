DROP DATABASE IF EXISTS FIGHTFORFLIGHTDB;
CREATE DATABASE FIGHTFORFLIGHTDB;
USE FIGHTFORFLIGHTDB;
...
CREATE USER 'root'@'%' identified by 'DolphinsrCute';
GRANT ALL ON FIGHTFORFLIGHTDB.* TO 'root'@'%';